  ...
  return (
    <>
      ...
      <div 
        ...
        data-logged-in-greeting="สวัสดีครับ! สนใจเช่ารถตู้หรือมีคำถามอ่ะไรไหมครับ? 🚌"
        data-logged-out-greeting="สวัสดีครับ! สนใจเช่ารถตู้หรือมีคำถามอ่ะไรไหมครับ? 🚌"
        data-greeting-dialog-display="show"
        data-greeting-dialog-delay="3"
        aria-label="Facebook Messenger Customer Chat"
        role="region"
      />
      <Script 
        id="facebook-jssdk" 
