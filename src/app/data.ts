...
export const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "@id": "https://www.vantrangforrent.com/#organization",
      "name": "รถตู้เช่าตรัง - Vantrangforrent.com",
      "description": "ผู้ให้บริการรถตู้เช่าตรังพร้อมคนขับมืออาชีพอันดับ 1 ให้บริการครอบคลุมการเดินทางทุกรูปแบบ ทั้งการนำเที่ยว, การรับส่งสนามบิน, และการเดินทางทั่วภาคใต้ รวมถึงบริการสำหรับองค์กร เช่น รถตู้รับส่งพนักงาน, เช่ารถตู้สัมมนา, และบริการสำหรับหน่วยงานราชการ ด้วยรถตู้หลากหลายรุ่นตั้งแต่ Toyota Commuter, Hiace, ไปจนถึงรถ VIP หรูอย่าง Alphard เรามุ่งมั่นให้บริการที่ปลอดภัย, สะดวกสบาย, และเชื่อถือได้ตลอด 24 ชั่วโมง",
