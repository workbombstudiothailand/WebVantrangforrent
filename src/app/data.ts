...
export const metadata: Metadata = {
  ...
  keywords: [
    // คีย์เวิร์ดหลัก
    "รถตู้เช่าตรัง", "เช่ารถตู้ตรัง", "รถตู้เช่าพร้อมคนขับตรัง", "ตรังรถตู้เช่า", "รถตู้เช่าตรัง ราคาถูก", "เหมารถตู้ตรัง",
    
    // คีย์เวิร์ดตามประเภทบริการ
    "รถตู้นำเที่ยวตรัง", "รถตู้ VIP ตรัง", "เช่ารถตู้ท่องเที่ยวตรัง", "รถตู้รับปริญญาตรัง",
    
    // คีย์เวิร์ดรับ-ส่ง
    "รถตู้รับส่งสนามบินตรัง", "รถตู้รับส่งสนามบินหาดใหญ่", "รถตู้รับส่งสนามบินกระบี่", "รถตู้รับส่งท่าเรือปากบารา", "เช่ารถตู้ตรังไปหลีเป๊ะ",
...
export const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "name": "รถตู้เช่าตรัง by vantrangforrent.com",
      "description": "บริการรถตู้เช่าตรังพร้อมคนขับ สำหรับนำเที่ยว, รับส่งสนามบินตรัง, หาดใหญ่, กระบี่ และเดินทางทั่วภาคใต้ เรามีรถตู้ VIP, Toyota Hiace, Commuter ให้บริการในราคาถูก ปลอดภัย บริการ 24 ชั่วโมง",
