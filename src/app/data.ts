...
export const metadata: Metadata = {
  title: "รถตู้เช่าภาคใต้【รถตู้เช่าตรัง อันดับ 1】พร้อมคนขับ | บริการ 24 ชม.",
...
export const jsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      "@type": "RentACarStore",
      "@id": "https://www.vantrangforrent.com/#organization",
      "name": "Vantrangforrent.com (รถตู้เช่าตรังและภาคใต้)",
      "branchCode": "Trang",
      "description": "ผู้ให้บริการรถตู้เช่าตรังพร้อมคนขับมืออาชีพอันดับ 1 ให้บริการครอบคลุมการเดินทางทุกรูปแบบทั่วทุกจังหวัดในภาคใต้ ตั้งแต่ชุมพร, ระนอง, สุราษฎร์ธานี (สมุย), พังงา, ภูเก็ต, กระบี่, นครศรีธรรมราช, ตรัง, พัทลุง, สตูล, สงขลา (หาดใหญ่), ไปจนถึงปัตตานี, ยะลา, และนราธิวาส เราเชี่ยวชาญบริการรับ-ส่งทุกสนามบินและนำเที่ยวทั่วภาคใต้ ด้วยรถตู้คุณภาพสูงที่ปลอดภัยและสะดวกสบาย",
      ...
      "areaServed": [
        ...
        { "@type": "City", "name": "ระนอง" },
        { "@type": "City", "name": "ชุมพร" },
        { "@type": "City", "name": "ปัตตานี" },
        { "@type": "City", "name": "ยะลา" },
        { "@type": "City", "name": "นราธิวาส" }
      ],
      "makesOffered": "Toyota",
